...
const Extracharges = () => {
  ...
  useEffect(() => {
    axios.get('https://isovia.ca/fms_api/api/fetchextrachargesProductData')
  ...
  const handleRemove = async (id) => {
    try {
      const response = await axios.post(
        ...
        new URLSearchParams({
          id: id,
          type: 'fms_extracharges'  // Adjust the type if necessary
        }).toString(),
        {
          headers: {
                        ...
                        <thead>
                          <tr role="row">
                            ...
                            <th
                              ...
                              rowSpan={1}
                              colSpan={1}
                              aria-label="Chargetype: activate to sort column ascending"
                              style={{ width: "208.2px" }}
                            >
                              Chargetype
                            </th>
                            <th
                              ...
                              rowSpan={1}
                              colSpan={1}
                              aria-label="CValue: activate to sort column ascending"
                              style={{ width: "143.2px" }}
                            >
                              CValue
                            </th>
                        ...
                        <tbody>
                          {currentData.map(item => (
                            <tr role="row" className="odd" key={item.id}>
                              ...
                              <td>
                                <Link
                                  to={`/extracharges/update/${item.id}`}
