...
const Factorings = () => {
  ...
  useEffect(() => {
    axios.get('https://isovia.ca/fms_api/api/fetchfactoringsProductData')
  ...
  const handleRemove = async (id) => {
    try {
      const response = await axios.post(
        ...
        new URLSearchParams({
          id: id,
          type: 'fms_factorings'  // Adjust the type if necessary
        }).toString(),
        {
          headers: {
      ...
      <section className="content">
        ...
        <div className="row">
          <div className="col-md-12 col-xs-12">
            <div id="messages" />
            <Link
              to={"/factorings/create"}
              className="btn btn-primary"
            >
              Add Factoring Companies
            </Link>
            <br /> <br />
            <div className="box">
