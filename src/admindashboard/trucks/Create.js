...
const Createtrucks = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post(`${BASE_URL}api/createtrucks`, data, {
      headers: {
                ...
                <div className="box-body">
                  <div className="row" style={{ padding: '10px', marginBottom: '20px', backgroundColor: '#f9f9f9', borderBottom: '1px solid #eee' }}>
                    <div className="col-md-6">
                      <label className="text-primary fw-bold"><i className="fa fa-magic"></i> AI Smart Scan</label>
                      ...
                      <small className="text-muted">Upload a registration or insurance document to auto-fill truck details.</small>
                    </div>
                  </div>
